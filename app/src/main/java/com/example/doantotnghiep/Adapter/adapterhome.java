...
public class adapterhome extends RecyclerView.Adapter<adapterhome.ViewHolder>  {
    ...
    private List<objhome> mListProduct;
    ...
    public interface IClickItemProductListener{
        void onClickItemProduct(objhome product);
    }

    public void setData( Context context, List<objhome> mList, MainActivity home) {
    ...
    public void onBindViewHolder(@NonNull adapterhome.ViewHolder holder, int position) {
        ...
        objhome product = mListProduct.get(position);
